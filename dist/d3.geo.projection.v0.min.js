!function () {
    ...
    function l() {
        var t = pa / 9, n = t > 0 ? 1 : -1, a = Math.tan(n * t), r = Qa(v), e = r(t), o = e.stream;
    ...
    function y(t) {
        function n(t, n) {
            ...
            if (Math.abs(t) > wa) {
                var e = Math.atan2(r[1], r[0]), o = Math.sqrt(r[0] * r[0] + r[1] * r[1]),
                    i = a * Math.round((e - wa) / a) + wa, u = Math.atan2(Math.sin(e -= i), 2 - Math.cos(e));
        ...
        return n.invert = function (t, n) {
            ...
            if (r > wa) {
                var e = Math.atan2(n, t), o = a * Math.round((e - wa) / a) + wa, i = e > o ? -1 : 1,
                    h = r * Math.cos(o - e),
    ...
    function S() {
        var t = 5, n = Qa(y), a = n(t), r = a.stream, e = .01, o = -Math.cos(e * ma), i = Math.sin(e * ma);
    ...
    function P(t) {
        function n(t, n) {
            var r = wa - n, e = r ? t * a * Math.sin(r) / r : r;
            return [r * Math.sin(e) / a, wa - r * Math.cos(e)]
        }

        var a = Math.sin(t);
        return n.invert = function (t, n) {
            var r = t * a, e = wa - n, o = Math.sqrt(r * r + e * e), i = Math.atan2(r, e);
    ...
    function _(t) {
        function n(n, a) {
            ...
            for (var c = u.slice(), M = 0; 3 > M; ++M) {
                var f = 2 == M ? 0 : M + 1, v = F(t[M].v[0], o[M][0], o[f][0]);
        ...
        var o = F(t[0].v[0], t[2].v[0], t[1].v[0]), i = F(t[0].v[0], t[1].v[0], t[2].v[0]), h = pa - o;
    ...
    function z() {
        var t = [[0, 0], [0, 0], [0, 0]], n = Qa(_), a = n(t), r = a.rotate;
    ...
    function Y(t, n) {
        function a(n, a) {
            var o = za(n, a), i = o[0], h = o[1], u = i * i + h * h;
            if (u > e) {
                var M = Math.sqrt(u), s = Math.atan2(h, i), c = r * Math.round(s / r), f = s - c, v = t * Math.cos(f),
                    l = (t * Math.sin(f) - f * Math.sin(v)) / (wa - v), g = Z(f, l), d = (pa - t) / tn(g, v, pa);
                i = M;
                var b, p = 50;
        ...
        return a.invert = function (n, a) {
            ...
            if (o > e) {
                ...
                for (var s = n - wa, c = Math.sin(n), f = a / c, v = wa > n ? 1 / 0 : 0, l = 10; ;) {
                    var g = t * Math.sin(f), d = t * Math.cos(f), b = Math.sin(d), p = wa - d, w = (g - f * b) / p,
                        q = Z(f, w);
    ...
    function $() {
        var t = 6, n = 30 * ma, a = Math.cos(n), r = Math.sin(n), e = Qa(Y), o = e(n, t), i = o.stream, h = .01,
            u = -Math.cos(h * ma), M = Math.sin(h * ma);
    ...
    function nn(t, n, a, r, e, o, i, h) {
        function u(u, M) {
            ...
            var s = M * M, c = t + s * (n + s * (a + s * r)), f = M * (e - 1 + s * (o - h + s * i)),
                v = (c * c + f * f) / (2 * f), l = u * Math.asin(c / v) / pa;
        ...
        return arguments.length < 8 && (h = 0), u.invert = function (u, s) {
            ...
            do {
                var d = l * l, b = t + d * (n + d * (a + d * r)), p = l * (e - 1 + d * (o - h + d * i)),
                    w = b * b + p * p, q = 2 * p, m = w / q, y = m * m, S = Math.asin(b / m) / pa, Q = v * S;
    ...
    function rn(t) {
        ...
        function a(n) {
            var a = n ? function (n, a) {
                var e = Math.abs(n) < wa, o = t(e ? n : n > 0 ? n - pa : n + pa, a), h = (o[0] - o[1]) * Math.SQRT1_2,
                    u = (o[0] + o[1]) * Math.SQRT1_2;
                if (e) return [h, u];
                var M = r * Math.SQRT1_2, s = h > 0 ^ u > 0 ? -1 : 1;
                return [s * h - i(u) * M, s * u - i(h) * M]
            } : function (n, a) {
                var e = n > 0 ? -.5 : .5, o = t(n + e * pa, a);
                return o[0] -= e * r, o
            };
            return t.invert && (a.invert = n ? function (n, a) {
                ...
                var e = n > 0 ? -.5 : .5, o = t.invert(n + e * r, a), i = o[0] - e * pa;
    ...
    function on(t, n) {
        ...
        if (t > .222 * pa || pa / 4 > n && t > .175 * pa) {
            ...
            var j, k = da, z = 25;
            do {
                var A = k * k, B = M(l - A), G = x + R * B, F = k * G + T * h(k / g) - E, C = G + (T - R * A) / B;
                k -= j = B ? F / C : 0
    ...
    function un(t, n, a) {
        ...
        var r = Mn(n, 1 - a), o = r[1] * r[1] + a * e[0] * e[0] * r[0] * r[0];
    ...
    function fn(t, n) {
        var a = (Math.SQRT2 - 1) / (Math.SQRT2 + 1), r = Math.sqrt(1 - a * a), e = cn(wa, r * r), o = -1,
            i = Math.log(Math.tan(pa / 4 + Math.abs(n) / 2)), h = Math.exp(o * i) / Math.sqrt(a),
            u = vn(h * Math.cos(o * t), h * Math.sin(o * t)), M = sn(u[0], u[1], r * r);
    ...
    function gn(t) {
        ...
        var a = Math.sin(t), r = Math.cos(t), e = dn(t);
    ...
    function bn() {
        var t = 0, n = Qa(gn), a = n(t), r = a.rotate, e = a.stream, o = d3.geo.circle();
    ...
    function yn(t) {
        ...
        var a = d3.geo.cylindricalEqualArea.raw(0), r = Ca * pa / 180, e = 2 * pa,
            o = d3.geo.collignon.raw(pa, r)[0] - d3.geo.collignon.raw(-pa, r)[0], i = a(0, r)[1],
            h = d3.geo.collignon.raw(0, r)[1], u = d3.geo.collignon.raw(0, wa)[1] - h, M = 2 * pa / t;
        return n.invert = function (n, r) {
            n *= 2;
            var s = Math.abs(r);
            if (s > i) {
    ...
    function Sn() {
        ...
        var n = 2, a = Qa(yn), r = a(n), e = r.stream;
    ...
    function Qn(t) {
        ...
        var a, r = 1 + t, e = Math.sin(1 / r), o = h(e), i = 2 * Math.sqrt(pa / (a = pa + 4 * o * r)),
    ...
    function Fn(t) {
        ...
        var a = Math.cos(t), r = Math.tan(pa / 4 + t / 2);
    ...
    function Nn(t, n) {
        var a, r = Math.min(18, 36 * Math.abs(n) / pa), e = Math.floor(r), o = r - e, i = (a = Za[e])[0], h = a[1],
            u = (a = Za[++e])[0], M = a[1], s = (a = Za[Math.min(19, ++e)])[0], c = a[1];
    ...
    function Xn(t, n) {
        var a = Math.tan(n / 2), r = Math.sin(pa / 4 * a);
    ...
    function ta() {
        var t = [[0, 0], [0, 0]], n = Qa($n), a = n(0), r = a.rotate;
        return delete a.rotate, a.points = function (a) {
            if (!arguments.length) return t;
            t = a;
            var e = d3.geo.interpolate(a[0], a[1]), o = e(.5), i = d3.geo.rotation([-o[0], -o[1]])(a[0]),
    ...
    function na(t, n) {
        if (Math.abs(n) < da) return [t, 0];
        var a = Math.abs(n / wa), r = h(a);
        if (Math.abs(t) < da || Math.abs(Math.abs(n) - wa) < da) return [0, i(n) * pa * Math.tan(r / 2)];
        var e = Math.cos(r), o = Math.abs(pa / t - t / pa) / 2, u = o * o, M = e / (a + e - 1), s = M * (2 / a - 1),
    ...
    function aa(t, n) {
        ...
        var a = Math.abs(n / wa), r = h(a);
        if (Math.abs(t) < da || Math.abs(Math.abs(n) - wa) < da) return [0, i(n) * pa * Math.tan(r / 2)];
        var e = Math.cos(r), o = Math.abs(pa / t - t / pa) / 2, u = o * o,
    ...
    function ra(t, n) {
        ...
        var e = (pa / t - t / pa) / 2, o = a / (1 + Math.cos(r));
    ...
    function ea(t, n) {
        ...
        var r = a / wa, e = r * r, o = (8 * r - e * (e + 2) - 5) / (2 * e * (r - 1)), h = o * o, u = r * o,
            s = e + h + 2 * u, c = r + 3 * o, f = t / wa, v = f + 1 / f, l = i(Math.abs(t) - wa) * Math.sqrt(v * v - 4),
            g = l * l, d = s * (e + h * g - 1) + (1 - e) * (e * (c * c + 4 * h) + 12 * u * h + 4 * h * h),
    ...
    var Ma = {
            ...
            point: function (t, n) {
                ...
                var t = sa.length ? sa.length < 2 ? {type: "Point", coordinates: sa[0]} : {
                    type: "MultiPoint",
                    coordinates: sa
                } : null;
                return sa = [], t
            ...
            lineStart: a, point: function (t, n) {
                ...
                var t = ca.length ? ca.length < 2 ? {type: "LineString", coordinates: ca[0]} : {
            ...
            polygonStart: a, lineStart: a, point: function (t, n) {
                ...
                }), ca = [], t.length ? t.length > 1 ? {type: "MultiPolygon", coordinates: t} : {
                    type: "Polygon",
                    coordinates: t[0]
                } : null
            }
        }, ga = {Point: fa, MultiPoint: fa, LineString: va, MultiLineString: va, Polygon: la, MultiPolygon: la, Sphere: la},
        da = 1e-6, ba = da * da, pa = Math.PI, wa = pa / 2, qa = Math.sqrt(pa), ma = pa / 180, ya = 180 / pa,
        Sa = d3.geo.projection, Qa = d3.geo.projectionMutator;
    d3.geo.interrupt = function (t) {
        ...
        function r() {
            for (var t = 1e-6, n = [], a = 0, r = h[0].length; r > a; ++a) {
                var o = h[0][a], i = 180 * o[0][0] / pa, u = 180 * o[0][1] / pa, M = 180 * o[1][1] / pa,
                    s = 180 * o[2][0] / pa, c = 180 * o[2][1] / pa;
                n.push(e([[i + t, u + t], [i + t, M - t], [s - t, M - t], [s - t, c + t]], 30))
            }
            for (var a = h[1].length - 1; a >= 0; --a) {
                var o = h[1][a], i = 180 * o[0][0] / pa, u = 180 * o[0][1] / pa, M = 180 * o[1][1] / pa,
                    s = 180 * o[2][0] / pa, c = 180 * o[2][1] / pa;
    ...
    var xa = Q(pa), Ea = R(Math.SQRT2 / wa, Math.SQRT2, pa);
    (d3.geo.mollweide = function () {
        ...
        var t = pa / 6, n = d3.geo.projectionMutator(P), a = n(t);
    ...
    (d3.geo.bromley = function () {
        ...
        var a = Math.sqrt(3), r = 3 * h(n / (a * qa));
        ...
        do {
            var i = r / 2, h = e / 2, u = Math.sin(i), M = Math.cos(i), s = Math.sin(h), c = Math.cos(h),
                ...
                x = -.5 * l * d * d * d, E = x * R, k = x * T, P = (P = 2 * c + Math.SQRT2 * v * (M - u)) * P * q,
                _ = (Math.SQRT2 * M * c * v + f) / P, z = -(Math.SQRT2 * u * s) / (v * P),
                B = m * E - 2 * _ / q + d * (_ + _ / w), F = m * k - 2 * z / q + d * (z + z / w),
                j = l * y * E - 2 * R / (1 + g) + d * y * R + d * l * (_ - _ / w),
                A = l * y * k - 2 * T / (1 + g) + d * y * T + d * l * (z - z / w), G = F * j - A * B;
            if (!G) break;
            var C = (Q * F - S * A) / G, D = (S * j - Q * B) / G;
    ...
    (d3.geo.fahey = function () {
        ...
        var a = Math.atan(n / qa), r = Math.cos(a), e = 2 * a;
    ...
    (d3.geo.ginzburg9 = function () {
        ...
        var a = i(t), r = i(n), e = -a * t, o = -r * n, u = 1 > o / e, M = hn(u ? o : e, u ? e : o), s = M[0], c = M[1];
        u && (s = -wa - s);
        ...
        var a = (Math.SQRT2 - 1) / (Math.SQRT2 + 1), r = Math.sqrt(1 - a * a), e = cn(wa, r * r), o = -1,
            i = un(.5 * e - n, -t, r * r), h = ln(i[0], i[1]), u = Math.atan2(h[1], h[0]) / o;
    ...
    var Da = .7109889596207567, La = .0528035274542;
    Tn.invert = function (t, n) {
        ...
        var a = Math.abs(t), r = Math.abs(n), e = pa / Math.SQRT2, o = da, i = wa;
        e > r ? i *= r / e : o += 6 * u(e / r);
        for (var h = 0; 25 > h; h++) {
    ...
    var Ha = 1.0148, Ia = .23185, Ja = -.14499, Ka = .02406, Na = Ha, Ua = 5 * Ia, Va = 7 * Ja, Wa = 9 * Ka,
        Xa = 1.790857183;
    ...
    Za.forEach(function (t) {
        ...
        var a = n / wa, r = 90 * a, e = Math.min(18, Math.abs(r / 5)), o = Math.max(0, Math.floor(e));
        do {
            var i = Za[o][1], h = Za[o + 1][1], u = Za[Math.min(19, o + 2)][1], M = u - i, s = u - 2 * h + i,
        ...
        var a = (t /= pa) * t, r = (n /= pa) * n, e = a + r, o = e * e, h = -Math.abs(n) * (1 + e), M = h - 2 * r + a,
        ...
        var a = Math.abs(t / pa), r = (1 - a * a - (n /= pa) * n) / (2 * a), e = r * r, o = Math.sqrt(e + 1);
        ...
        if (!n) return [t, 0];
        var a = n / pa, r = (pa * pa * (1 - a * a) - t * t) / (2 * pa * t);
        ...
        if (!t || !n) return [t, n];
        n /= pa;
        var a = i(t) * t / wa, r = (a * a - 1 + 4 * n * n) / Math.abs(a), e = r * r, o = 2 * n, h = 50;
        do {
    ...
    var $a = function () {
        var t = 4 * pa + 3 * Math.sqrt(3), n = 2 * Math.sqrt(2 * pa * Math.sqrt(3) / t);
    ...
    (d3.geo.wagner4 = function () {
        ...
        do {
            var o, i = Math.cos(r), h = Math.sin(r), M = Math.sin(2 * r), s = h * h, c = i * i, f = Math.sin(a),
                ...
                b = d ? u(i * v) * Math.sqrt(o = 1 / d) : o = 0, p = .5 * (2 * b * i * l + a / wa) - t,
                w = .5 * (b * h + r) - n, q = .5 * o * (c * g + b * i * v * s) + .5 / wa,
